const Frame = () => {
  return (
    <div className="relative bg-bg w-full h-[5902px] overflow-hidden text-left text-base text-text font-title-12px-medium">
      ...
      <div className="absolute top-[1219px] left-[603px] rounded bg-button2 flex flex-row items-center justify-center py-4 px-12">
        <div className="relative leading-[24px] font-medium">
          View All Products
        </div>
      </div>
      <div className="absolute top-[2526px] left-[135px] bg-text2 w-[1170px] h-[500px] overflow-hidden">
        <div className="absolute top-[0px] left-[552px] rounded-[50%] bg-gainsboro [filter:blur(200px)] w-[504px] h-[500px] opacity-[0.3]" />
        <div className="absolute top-[121px] left-[56px] text-29xl tracking-[0.04em] leading-[60px] font-semibold font-heading-48px-semibold inline-block w-[443px]">
        ...
        <div className="absolute top-[375px] left-[56px] rounded bg-button1 flex flex-row items-center justify-center py-4 px-12">
      ...
      <div className="absolute top-[646px] left-[17px] flex flex-col items-start justify-start gap-[40px] text-button2">
        <div className="flex flex-row items-end justify-start gap-[470px]">
          <div className="flex flex-row items-end justify-start gap-[87px]">
            <div className="h-[103px] flex flex-col items-start justify-start gap-[24px]">
              ...
              <div className="relative text-17xl tracking-[0.04em] leading-[48px] font-semibold font-heading-48px-semibold text-text2">
                Flash Sales
              </div>
            </div>
            <div className="relative w-[302px] h-[50px] text-xs text-text2">
              <div className="absolute top-[calc(50%_-_25px)] left-[calc(50%_-_151px)] h-[50px] flex flex-col items-start justify-start gap-[4px]">
                <div className="relative leading-[18px] font-medium inline-block w-[31px]">
                  Days
                </div>
                <b className="relative text-13xl tracking-[0.04em] leading-[30px] inline-block font-heading-48px-semibold w-[46px] h-7 shrink-0">
                  03
                </b>
              </div>
              <div className="absolute top-[calc(50%_-_25px)] left-[calc(50%_-_67px)] w-[42px] h-[50px] flex flex-col items-start justify-start gap-[4px]">
                <div className="relative leading-[18px] font-medium inline-block w-[35px]">
                  Hours
                </div>
                <b className="relative text-13xl tracking-[0.04em] leading-[30px] font-heading-48px-semibold">
                  23
                </b>
              </div>
              <div className="absolute top-[calc(50%_-_25px)] left-[calc(50%_+_13px)] w-[49px] h-[50px] flex flex-col items-start justify-start gap-[4px]">
                <div className="relative leading-[18px] font-medium inline-block w-[49px]">
                  Minutes
                </div>
                <b className="relative text-13xl tracking-[0.04em] leading-[30px] inline-block font-heading-48px-semibold w-[39px] h-7 shrink-0">
                  19
                </b>
              </div>
              <div className="absolute top-[calc(50%_-_25px)] left-[calc(50%_+_100px)] w-[51px] h-[50px] flex flex-col items-start justify-start gap-[4px]">
              ...
              <div className="absolute top-[26px] left-[63px] flex flex-col items-start justify-start gap-[8px]">
                <div className="relative rounded-[50%] bg-hover-button w-1 h-1" />
                <div className="relative rounded-[50%] bg-hover-button w-1 h-1" />
              </div>
              <div className="absolute top-[26px] left-[143px] flex flex-col items-start justify-start gap-[8px]">
                <div className="relative rounded-[50%] bg-hover-button w-1 h-1" />
                <div className="relative rounded-[50%] bg-hover-button w-1 h-1" />
              </div>
              <div className="absolute top-[26px] left-[230px] flex flex-col items-start justify-start gap-[8px]">
                <div className="relative rounded-[50%] bg-hover-button w-1 h-1" />
                <div className="relative rounded-[50%] bg-hover-button w-1 h-1" />
              </div>
            </div>
        ...
        <div className="flex flex-row items-start justify-start gap-[30px] text-xs text-text">
          <div className="flex flex-col items-start justify-start gap-[16px]">
            <div className="relative rounded bg-secondary w-[270px] h-[250px] overflow-hidden shrink-0">
              <div className="absolute top-[12px] left-[12px] rounded bg-button2 flex flex-row items-center justify-center py-1 px-3">
      ...
      <div className="absolute top-[1415px] left-[135px] flex flex-col items-start justify-start gap-[60px] text-button2">
      ...
      <div className="absolute top-[1868px] left-[135px] flex flex-col items-start justify-start gap-[60px] text-button2">
        <div className="flex flex-row items-end justify-start gap-[611px]">
          ...
          <div className="rounded bg-button2 flex flex-row items-center justify-center py-4 px-12 text-text">
      ...
      <div className="absolute top-[3097px] left-[135px] flex flex-col items-center justify-start gap-[60px] text-button2">
            ...
            <div className="flex flex-row items-start justify-start gap-[30px] text-xs text-text">
              <div className="flex flex-col items-start justify-start gap-[16px]">
                <div className="relative rounded bg-secondary w-[270px] h-[250px] overflow-hidden shrink-0">
                  ...
                  <div className="absolute top-[12px] left-[12px] rounded bg-button1 flex flex-row items-center justify-center py-1 px-3">
      ...
      <div className="absolute top-[4253px] left-[135px] flex flex-col items-start justify-start gap-[60px] text-button2">
        <div className="flex flex-col items-start justify-start gap-[20px]">
          <div className="flex flex-row items-center justify-start gap-[16px]">
            <div className="relative w-5 h-10">
              <div className="absolute h-full w-full top-[0%] right-[0%] bottom-[0%] left-[0%] rounded bg-button2" />
        ...
        <div className="flex flex-row items-start justify-start gap-[30px] text-5xl text-text font-heading-48px-semibold">
          <div className="relative rounded bg-text2 w-[570px] h-[600px] overflow-hidden shrink-0">
            ...
            <div className="absolute top-[446px] left-[32px] flex flex-col items-start justify-start gap-[16px]">
              <div className="flex flex-col items-start justify-start gap-[16px]">
                ...
                <div className="relative text-sm leading-[21px] font-title-12px-medium inline-block w-[242px]">
                  Black and White version of the PS5 coming out on sale.
                </div>
              </div>
              <div className="flex flex-col items-start justify-start text-base text-bg font-title-12px-medium">
                <div className="relative leading-[24px] font-medium">
                  Shop Now
                </div>
                <img
            ...
            <div className="relative rounded bg-gray-100 w-[570px] h-[284px] overflow-hidden shrink-0">
              ...
              <div className="absolute top-[138px] left-[24px] flex flex-col items-start justify-start gap-[16px]">
                <div className="flex flex-col items-start justify-start gap-[16px]">
                  ...
                  <div className="relative text-sm leading-[21px] font-title-12px-medium inline-block w-[255px]">
              ...
              <div className="relative rounded bg-text2 w-[270px] h-[284px] overflow-hidden shrink-0">
                ...
                <div className="absolute top-[175px] left-[24px] flex flex-col items-start justify-start gap-[8px]">
                  <div className="flex flex-col items-start justify-start gap-[8px]">
                    ...
                    <div className="relative text-sm leading-[21px] font-title-12px-medium inline-block w-[191px]">
      ...
      <div className="absolute top-[4872px] left-[1059px] flex flex-col items-start justify-start gap-[8px] text-5xl font-heading-48px-semibold">
        <div className="flex flex-col items-start justify-start gap-[8px]">
          <div className="relative tracking-[0.03em] leading-[24px] font-semibold">
            Perfume
          </div>
      ...
      <div className="absolute top-[5161px] left-[249px] flex flex-row items-center justify-center gap-[88px] text-xl text-text2">
        ...
        <div className="hidden flex-col items-center justify-start gap-[24px]">
          <img className="relative w-20 h-20" alt="" src="/fill-heart1.svg" />
          <div className="flex flex-col items-center justify-start gap-[8px]">
            <div className="relative leading-[28px] font-semibold">
              MONEY BACK GUARANTEE
            </div>
      ...
      <div className="absolute top-[5462px] left-[0px] bg-text2 w-[1440px] h-[440px] overflow-hidden text-bg">
        ...
        <div className="absolute top-[80px] left-[135px] flex flex-row items-start justify-center gap-[87px] text-xl text-text">
          <div className="flex flex-col items-start justify-start gap-[16px] text-5xl font-heading-48px-semibold">
            <div className="flex flex-col items-start justify-start gap-[24px]">
              <div className="flex flex-col items-start justify-start gap-[24px]">
                ...
                <div className="relative text-xl leading-[28px] font-medium font-title-12px-medium">
                  Subscribe
                </div>
              </div>
            ...
            <div className="rounded box-border w-[217px] flex flex-row items-center justify-start py-3 pr-0 pl-4 gap-[32px] text-base font-title-12px-medium border-[1.5px] border-solid border-text">
      ...
      />
      <div className="absolute top-[46px] left-[1138px] bg-text2 w-[1440px] h-12 overflow-hidden text-sm">
      ...
      <div className="absolute top-[228px] left-[527px] bg-text2 w-[892px] h-[344px] overflow-hidden text-center">
        <img
          className="absolute top-[16px] left-[396px] w-[496px] h-[352px] object-cover"
          alt=""
          src="/hero-endframe--cvklg0xk3w6e-large-2@2x.png"
        />
        <div className="absolute top-[58px] left-[64px] flex flex-row items-center justify-start gap-[24px]">
          <img
            className="relative w-10 h-[49px] object-cover"
            alt=""
            src="/1200pxapple-gray-logo-1@2x.png"
          />
          <div className="relative leading-[24px] inline-block w-[126px] h-5 shrink-0">
            iPhone 14 Series
          </div>
        </div>
        <div className="absolute top-[127px] left-[64px] text-29xl tracking-[0.04em] leading-[60px] font-semibold font-heading-48px-semibold text-left inline-block w-[294px]">
          Up to 10% off Voucher
        </div>
        <div className="absolute top-[269px] left-[67px] flex flex-row items-center justify-start gap-[8px]">
          <div className="flex flex-col items-start justify-start gap-[4px]">
            <div className="relative leading-[24px] font-medium">Shop Now</div>
        ...
        <div className="absolute top-[321px] left-[401px] rounded-[50%] bg-button2 w-2.5 h-2.5" />
        <div className="absolute top-[319px] left-[353px] flex flex-row items-center justify-center gap-[11px]">
          <div className="relative rounded-[50%] bg-bg w-3 h-3 opacity-[0.5]" />
          <div className="relative rounded-[50%] bg-bg w-3 h-3 opacity-[0.5]" />
          <div className="relative rounded-[50%] box-border w-3.5 h-3.5 border-[2px] border-solid border-bg" />
          <div className="relative rounded-[50%] bg-bg w-3 h-3 opacity-[0.5]" />
          <div className="relative rounded-[50%] bg-bg w-3 h-3 opacity-[0.5]" />
        </div>
      </div>
      <div className="absolute top-[50px] left-[70px] bg-text2 w-[1440px] h-12 overflow-hidden text-sm">
        <div className="absolute top-[12px] right-[136px] flex flex-row items-start justify-start gap-[231px]">
          <div className="flex flex-row items-center justify-start gap-[8px]">
            <div className="relative leading-[21px] inline-block w-[474px] h-[18px] shrink-0">
              Summer Sale For All Swim Suits And Free Express Delivery - OFF
      ...
      <div className="absolute top-[173px] left-[662px] flex flex-row items-center justify-start gap-[130px] text-5xl text-text2 font-heading-48px-semibold">
        <div className="flex flex-row items-start justify-start gap-[160px]">
          <div className="relative w-[118px] h-6">
            <b className="absolute top-[0%] left-[0%] tracking-[0.03em] leading-[24px]">
              Exclusive
            </b>
          </div>
          <div className="flex flex-row items-start justify-start gap-[48px] text-center text-base font-title-12px-medium">
        ...
        <div className="flex flex-row items-center justify-start gap-[24px] text-xs font-title-12px-medium">
          <div className="rounded bg-secondary flex flex-col items-center justify-center py-[7px] pr-3 pl-5">
          ...
          <div className="flex flex-row items-center justify-center gap-[16px] text-center text-text">
            <img
            ...
            <div className="relative w-8 h-8">
              ...
              <div className="absolute h-[53.13%] w-6/12 top-[3.13%] right-[3.13%] bottom-[43.75%] left-[46.88%]">
                <div className="absolute h-[94.12%] w-full top-[5.88%] right-[0%] bottom-[0%] left-[0%] rounded-[50%] bg-button2" />
            ...
            <img
              className="relative rounded-28xl w-8 h-8 overflow-hidden shrink-0"
              alt=""
              src="/fill-heart1.svg"
            />
          </div>
      ...
      <img
        className="absolute top-[188px] left-[114px] w-[1440px] h-[0.5px]"
        alt=""
        src="/line-3.svg"
      />
      <div className="absolute top-[172px] left-[1195px] w-[225px] h-52 text-center text-sm">
        <div className="absolute h-full w-[99.56%] top-[0%] right-[0.44%] bottom-[0%] left-[0%] rounded bg-gray-400 [backdrop-filter:blur(150px)] overflow-hidden">
          <div className="absolute top-[18px] left-[20px] flex flex-col items-start justify-start gap-[13px]">
            <div className="flex flex-row items-center justify-start gap-[16px]">
              <img
                className="relative w-8 h-8 overflow-hidden shrink-0"
                alt=""
                src="/user.svg"
              />
              <div className="relative leading-[21px]">Manage My Account</div>
            </div>
            <div className="flex flex-row items-center justify-start gap-[16px]">
              <img
                className="relative w-6 h-6 overflow-hidden shrink-0"
            ...
            <div className="flex flex-row items-center justify-start gap-[16px]">
              <img
                ...
                src="/iconcancel.svg"
              />
              <div className="relative leading-[21px]">My Cancellations</div>
            </div>
            <div className="flex flex-row items-center justify-start gap-[16px]">
              <img className="relative w-6 h-6" alt="" src="/iconreviews.svg" />
